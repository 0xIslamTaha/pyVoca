import argparse
from voca.vocaCreator import vocaCreatro
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', help='revision random n words', dest='revision', default=10, action='store')
    options = parser.parse_args()

    SEARCH_LIST = options.search
    REVISION_NUMBER = options.revision

    vocaCreatro().looking_for_list(SEARCH_LIST)
